...
def main():
    ...
    red = {'bw': args.bw, 'delay': str( args.delay)+'ms','max_queue_size': args.queue,'enable_red':1,\
            'enable_ecn': 0, 'red_burst':31,'red_prob':0.1,'red_avpkt':1500,'red_min':45000, 'red_max':90000,'red_limit':1000000}
